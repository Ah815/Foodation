    ...
    <div className="flex flex-col min-h-screen bg-white lg:flex-row">
      ...
      <div className="w-full lg:w-64 bg-white shadow-md">
        ...
        <nav className="mt-8">
          ...
          <Link href="/Organization-Listing" className="flex items-center px-4 py-2 text-green-500">
            <Image src="/Icons 4.png" className="mr-2" width={20} height={20}/>
            User Listing
          </Link>
          ...
          <Link href="Organization-Goals" className="flex items-center px-4 py-2 text-gray-400">
            <Image src="/goals.png" className="mr-2" width={20} height={20}/>
            Goals
          </Link>
