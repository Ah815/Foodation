          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm mr-8">
            <div className="p-6">
              ...
              <div className="flex justify-between mb-4">
                <div>
                  <button className="px-4 py-2 hover:text-green-500 text-gray-400">
                    <Link href="/Organization-Goals">
                      <p className="hover:underline">Unfinished Goals  10</p>
                    </Link>
                  </button>     
                  <button className="px-4 py-2 text-green-500">
                   <p className="underline">Completed Goals  10</p>
                  </button>
                </div>
              ...
              <div className="space-y-4">
                ...
                {goals.map((goal) => (
                  <div key={goal.id} className="flex items-center space-x-4 mb-4 p-4 border rounded-lg">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center mt-2">
                        ...
                        <span className="text-xs text-gray-500">{goal.enrolled} 22/40 enrolled</span>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
